...
echo ""
echo "📹 To set up video generation, run:"
echo "  chmod +x setup_video_gen_simple.sh"
echo "  ./setup_video_gen_simple.sh"
echo "📖 See runpod/VIDEO_SETUP.md for detailed instructions"
